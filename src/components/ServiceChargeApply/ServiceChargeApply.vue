    ...
    <transition name="pop-right">
        <layout-base class="charge-apply" v-if="show">
            ...
            <div class="page">
                ...
                <ul>
                    <service-charge-apply-item :value="v" v-for="(v, i) in info.items" :key="i" @Select="select" @Change="changeData"></service-charge-apply-item>
                </ul>
            </div>
...
<script>
import ServiceChargeApplyItem from '../ServiceChargeApplyItem/ServiceChargeApplyItem.vue'

export default {
    components: {
        ServiceChargeApplyItem
    },
    model: {
        prop: 'show',
        event: 'Hidden'
